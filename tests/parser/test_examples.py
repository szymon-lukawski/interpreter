...
def test_if_if_else():
    ...
    assert (
        type(result.children[3].else_prog.children[0].expr.children[0]) == ObjectAccess
    )
    assert result.children[3].else_prog.children[0].expr.children[0].name_chain == [
        "msg"
    ]
...
def test_variant_example():
    ...
    expected = Program(
        [
            VariableDeclaration(
                "jakis_warunek", "int", False, IntLiteral(1, None), pos=(2, 5)
            ),
            VariantDef(
                "Liczba",
                [
                    NamedType("calkowita", "int", pos=(5, 9)),
                    NamedType("zmiennoprzecinkowa", "float", pos=(6, 9)),
                ],
                (3, 5),
            ),
            VariableDeclaration("moja_liczba", "Liczba", False, pos=(8, 5)),
            IfStatement(
                ObjectAccess(["jakis_warunek"], pos=(9, 8)),
                Program(
                    [
                        AssignmentStatement(
                            ObjectAccess(["moja_liczba"]), IntLiteral(30, None), (11, 9)
                        )
                    ],
                    (11, 9),
                ),
                Program(
                    [
                        AssignmentStatement(
                            ObjectAccess(["moja_liczba"]),
                            FloatLiteral(3.14, None),
                            (14, 9),
                        )
                    ],
                    (14, 9),
            ...
            VariableDeclaration("wynik", "str", False, pos=(16, 5)),
            VisitStatement(
                ObjectAccess(["moja_liczba"], pos=(17, 11)),
                [
                    CaseSection(
                        "int",
                        Program(
                            [
                                AssignmentStatement(
                                    ObjectAccess(["wynik"]),
                                    ObjectAccess(
                                        ["moja_liczba", "calkowita"], pos=(20, 21)
                                    ),
                                    (20, 13),
                                )
                            ],
                        ...
                        Program(
                            [
                                AssignmentStatement(
                                    ObjectAccess(["wynik"]),
                                    ObjectAccess(
                                        ["moja_liczba", "zmiennoprzecinkowa"],
                                        pos=(23, 21),
                                    ),
                                    (23, 13),
                                )
    ...
    expected = Program(
        [
            FuncDef(
                "add",
                [
                    Param("arg1", "int", False, pos=(1, 5)),
                    Param("arg2", "int", False, pos=(1, 16)),
                ],
                "int",
                Program(
                    [
                        FuncDef(
                            "add_sub_function",
                            [
                                Param("arg1", "int", False, pos=(3, 20)),
                                Param("arg2", "int", False, pos=(3, 31)),
                            ],
                            "int",
                            Program(
                                [
                                    ReturnStatement(
                                        AddExpr(
                                            [
                                                ObjectAccess(["arg1"], pos=(5, 12)),
                                                ObjectAccess(["arg2"], pos=(5, 19)),
                                            ],
                                            ["+"],
                                            pos=(5, 12),
                                        ),
                        ...
                        FuncDef(
                            "add",
                            [
                                Param("arg1", "int", False, pos=(8, 7)),
                                Param("arg2", "int", False, pos=(8, 18)),
                            ],
                            "int",
                            Program(
                                [
                            ...
                            ObjectAccess(
                                [
                                    FunctionCall(
                                        "add",
                                        [
                                            ObjectAccess(["arg1"], pos=(13, 14)),
                                            ObjectAccess(["arg2"], pos=(13, 20)),
                                        ],
                                        pos=(13, 10),
                                    )
                                ],
